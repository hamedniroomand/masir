...
- Optional Google Analytics through `@nuxt/scripts` and `NUXT_PUBLIC_SCRIPTS_GOOGLE_ANALYTICS_ID`
...
- A set maximum visits shows a Remove limit button; a cleared field also means no limit
