...
const TABLES = 'job_runs, click_events, link_daily_stats, audit_events, link_tags, tags, links, campaigns, mail_outbox, user_tokens, auth_identities, workspace_invitations, workspace_members, workspaces, users';
